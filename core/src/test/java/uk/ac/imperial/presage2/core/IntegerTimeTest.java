...
public class IntegerTimeTest {
	...
	/**
	 * Test method for
	 * {@link uk.ac.imperial.presage2.core.IntegerTime#IntegerTime(int)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link uk.ac.imperial.presage2.core.IntegerTime#equals(uk.ac.imperial.presage2.core.Time)}
	 * .
	 */
	@Test
	public void testEqualsTime() {
		...
		assertFalse("IntegerTime(0).equals(null) should be false",
				t1.equals(null));
		...
		assertFalse("IntegerTime().equals(x != 0) should be false",
				t1.equals(t1Check));
		...
		assertTrue("IntegerTime().equals(IntegerTime()) should be true",
				t1.equals(t2));

		// int constructor vs other values and literals.
		Time t3 = new IntegerTime(t3Value);
		assertFalse(
				"IntegerTime().equals(IntegerTime(N != 0)) should be false",
				t2.equals(t3));
		assertFalse(
				"IntegerTime(N != 0).equals(IntegerTime()) should be false",
				t3.equals(t2));
		...
		assertFalse("IntegerTime(N).equals(X != N) should be false",
				t3.equals(t3Check));
		assertFalse("IntegerTime(N).equals(Integer(X != N)) should be false",
				t3.equals(Integer.valueOf(t3Check)));

		assertTrue("IntegerTime.equals should work with Time cast to object",
				t1.equals((Object) t2));
		assertFalse("IntegerTime.equals should work with Time cast to object",
				t2.equals((Object) t3));

		assertFalse(
				"IntegerTime.equals(A) where A is not Time or Integer should return false",
				t1.equals("0"));
	...
	/**
	 * Test method for
	 * {@link uk.ac.imperial.presage2.core.IntegerTime#increment()}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link uk.ac.imperial.presage2.core.IntegerTime#setTime(uk.ac.imperial.presage2.core.Time)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link uk.ac.imperial.presage2.core.IntegerTime#toString()}.
	 */
	@Test
	public void testToString() {
		Integer n = Integer.valueOf(rand.nextInt());
	...
	public void testClone() {
		...
		assertNotSame("Cloned objects should not reference the same object",
				t2, t1);
	}
	...
	public void testGreaterThan() {
		...
		assertTrue("IntegerTime(Y>X).greaterThan(X) should be true",
				t3.greaterThan(t1));
		assertFalse("IntegerTime(Y<X).greaterThan(X) should be false",
				t1.greaterThan(t3));
		assertFalse("IntegerTime(Y==X).greaterThan(X) should be false",
				t1.greaterThan(t2));
